...
mysqli_free_result($isInserted);            // not sure if needed for every query

$query= 'INSERT INTO Account_Access (account_ID, email, password) VALUES ("E1", "a@b.com", "123"), ("E2", "c@d.com", "456"), ("C1", "e@f.com", "789");';
$isInserted = mysqli_query($db, $query);
...
$query= 'INSERT INTO Vehicle_Details (full_car_name, seat_capacity, model_year, car_description, color, fuel_type, user_rate, car_type, millage) VALUES
    ("Toyota Camry S", 4, "2020", "Great car", "Red", "Gas", "A", "Sedan", 10000),
    ("Honda Civic", 4, "2019", "Average car", "Blue", "Gas", "B", "Sedan", 80000)
    (Toyota Tacoma, 2, "2018", "Average car but great space", "Black", "Gas", "B", "Pickup", 50000);
    (Honda Accord, 4, "2017", "Average car", "White", "Gas", "A", "Sedan", 60300);'; // no need for info ID as it is auto incremented
$isInserted = mysqli_query($db, $query);
...
$query= 'INSERT INTO Car_Storage (info_ID, car_ID, branch_ID, car_status, location, price, registration_No, daily_rate ) VALUES 
    (0, "TCAS1", "B1","A","101 Garage St", "200.00", "A123BS8092", 20), (1, "HCI1", "B1","U","200 Repairshop St", "220.00", "A123BS8093", 0)
    (3, "HAC1", "B2","A","1001 garage St.", "200.00", "A123BS8094", 80), (2, "TTA2", "B1","A","200 Repairshop St", "220.00", "A123BS8095", 17);';
$isInserted = mysqli_query($db, $query);
